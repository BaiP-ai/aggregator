      ...
      <div class="p-6 flex-grow">
        <div class="flex items-center mb-4">
          <div class="w-12 h-12 mr-4 flex-shrink-0 bg-gray-100 dark:bg-gray-700 rounded-md flex items-center justify-center overflow-hidden">
            {tool.logo ? 
              <img src={getAssetPath(tool.logo)} alt={`${tool.name} logo`} class="w-10 h-10 object-contain" onError={`this.src='images/logos/placeholder.svg'`} /> :
              <img src="images/logos/placeholder.svg" alt={`${tool.name} logo`} class="w-10 h-10 object-contain" />
            }
          </div>
          <div>
